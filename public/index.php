...
$cliente5 = new \SON\Cliente\Types\PessoaFisica("333.333.333-12", "José Silva", "011 4444-5555", 3);
$cliente5->setEnderecos(new \SON\Cliente\Endereco("Rua Benedito Barbosa", 1200, "São Bernardo do Campo", "SP", "33333-333"))
        ->setEnderecos(new \SON\Cliente\Endereco("Rua Benedito Barbosa", 1252, "São Bernardo do Campo", "SP", "33333-333"));
...
$cliente7 = new \SON\Cliente\Types\PessoaFisica("333.333.333-12", "José Silva", "011 4444-5555", 3);
$cliente7->setEnderecos(new \SON\Cliente\Endereco("Rua Benedito Barbosa", 1200, "São Bernardo do Campo", "SP", "33333-333"))
        ->setEnderecos(new \SON\Cliente\Endereco("Rua Benedito Barbosa", 1252, "São Bernardo do Campo", "SP", "33333-333"));
...
$cliente9 = new \SON\Cliente\Types\PessoaJuridica("33.555.555/0001-01", "111.222.333.444", "Empresa 1 Ltda", "Empresa 1", "011 5555-5555", 2);
$cliente9->setEnderecos(new \SON\Cliente\Endereco("Avenida Paulista", 1100, "São Paulo", "SP", "45455-222"));

$cliente10 = new \SON\Cliente\Types\PessoaFisica("333.333.333-12", "José Silva", "011 4444-5555", 3);
$cliente10->setEnderecos(new \SON\Cliente\Endereco("Rua Benedito Barbosa", 1200, "São Bernardo do Campo", "SP", "33333-333"))
        ->setEnderecos(new \SON\Cliente\Endereco("Rua Benedito Barbosa", 1252, "São Bernardo do Campo", "SP", "33333-333"));
        ...
        <nav class="navbar navbar-inverse" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">Code Education - POO</a>
                </div>
